...
import cn.itcast.shop.model.Cart;
import cn.itcast.shop.model.CartItem;
...
public class OrderAction extends ActionSupport implements ModelDriven<Order> {
	//private Sid sid;
	//Integer oid =Integer.parseInt(sid.nextShort() );
	...
	public String payOrder() throws IOException {
		...
		String p8_Url = "http://localhost:8080/Shop3/order_callBack.action"; // 商户接收支付成功数据的地址:
		String p9_SAF = ""; // 送货地址:
		String pa_MP = ""; // 商户扩展信息:
	...
	public String callBack() {
		...
		orderService.update(currOrder);
		this.addActionMessage("支付成功!订单编号为: " + r6_Order + " 付款金额为: " + r3_Amt+"元");
		return "msg";
	}
