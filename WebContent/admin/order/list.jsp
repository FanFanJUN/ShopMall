								...
								<tr
									...
									<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="12%">
												<s:property value="%{getText('{0,date,yyyy-MM-dd HH:mm:ss}',{#o.ordertime})}" />
											</td>
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
												width="8%">
											...
											<td align="center" style="HEIGHT: 22px">
												<input type="button" value="订单详情" id="but<s:property value="#o.oid"/>" onclick="show('<s:property value="#o.oid"/>')"/>
												<!-- <input type="button" value="订单详情"  onclick="show2()"/> -->
