	...
	<div class="span5">
		<div class="logo">
			<a href="${pageContext.request.contextPath}/index.action">
				<img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif" alt="熊熊购物商城"/>
			</a>
		</div>
	</div>
	<div class="span9">
			...
			<form id="cartForm" action="${ pageContext.request.contextPath }/cart_addCart.action" method="post" >
				...
				<div class="action">
					...
					<div class="buy">
							...
							<input id="addCart" class="addCart"  type="button" onclick="saveCart()"/>
<!-- 							<input id="addCart" class="btn btn-default" type="submit" value="提交" onclick="saveCart()"/>
 -->					</div>
				</div>
			</form>
