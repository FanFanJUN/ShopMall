			...
			<div class="step step1">
				...
				<table>
					...
					<tr>
						...
						<tr>
							<td width="60"><a href="${ pageContext.request.contextPath }/product_findByPid.action?pid=<s:property value="#orderItem.product.pid"/>">
				...
				<div class="span24">
					<p>
						...
						<p>
							...
							<input type="radio" name="pd_FrpId" value="SPDB-NET-B2C"/>上海浦东
							<img src="${ pageContext.request.contextPath }/bank_img/shpd.bmp" align="middle"/>
							<br/>
							...
							<img src="${ pageContext.request.contextPath }/bank_img/ningbo.bmp" align="middle"/>
							<br />
							或者以下方式：<br/>
							<input type="radio" name="pd_FrpId" value="UNICOM-NET"/>联通卡
							<input type="radio" name="pd_FrpId" value="YPCARD-NET"/>易宝一卡通
							<input type="radio" name="pd_FrpId" value="TELECOM-NET "/>电信卡
							<input type="radio" name="pd_FrpId" value="QQCARD-NET"/>Q币卡
						</p>
						<hr />
						<p style="text-align:center">
							<!-- <a class="btn btn-primary btn-danger btn-lg active" 
							href="javascript:document.getElementById('orderForm').submit();">立即支付</a> -->
							<a href="javascript:document.getElementById('orderForm').submit();">
								<img src="${pageContext.request.contextPath}/images/pay.jpg" width="204" height="51" border="0" />
							</a>
						</p>
				</div>
			</form>
